...
public class EnviroSkyEditor : Editor {
	...
	SerializedProperty effectQuality, updateInterval, lightningEffect, lightningRangeX, lightningRangeZMin, lightningRangeZMax, lightningHeight;
	...
	void OnEnable()
	{
       ...
       // skyNoiseIntensity = serializedObj.FindProperty("skySettings.noiseIntensity");
        ...
        lightningRangeX = serializedObj.FindProperty("weatherSettings.lightningRangeX");
        lightningRangeZMin = serializedObj.FindProperty("weatherSettings.lightningRangeZMin");
        lightningRangeZMax = serializedObj.FindProperty("weatherSettings.lightningRangeZMax");
		...
		if (myTarget.profile != null) {
			...
			if (myTarget.showSettings) {
				...
				case EnviroProfile.settingsMode.Weather:
                    ...
                    EditorGUILayout.PropertyField(lightningRangeX, true, null);
                    EditorGUILayout.PropertyField(lightningRangeZMin, true, null);
                    EditorGUILayout.PropertyField(lightningRangeZMax, true, null);
