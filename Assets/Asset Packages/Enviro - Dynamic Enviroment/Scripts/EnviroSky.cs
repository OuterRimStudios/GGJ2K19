...
public class EnviroSky : MonoBehaviour
{
    ...
    public IEnumerator PlayLightningEffect(Vector3 position)
    {
        ...
        lightningEffect.transform.eulerAngles = new Vector3(UnityEngine.Random.Range(-50f, -100f), 0f, 0f);
    ...
    public void PlayLightning ()
	{
        ...
        StartCoroutine(PlayLightningEffect(new Vector3(UnityEngine.Random.Range(-weatherSettings.lightningRangeX, weatherSettings.lightningRangeX), weatherSettings.lightningHeight,UnityEngine.Random.Range(weatherSettings.lightningRangeZMin, weatherSettings.lightningRangeZMax))));
